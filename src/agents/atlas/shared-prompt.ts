...
**NEVER ask "should I continue?" between steps.** After verification passes → immediately delegate next task.

Only pause when: plan needs clarification before execution, blocked by external dependency, or critical failure prevents all progress.
</auto_continue>`
